  ...
  <>
    ...
    <div className="pt-20">
      <section className="py-32 md:py-44 px-6 bg-[#080808] text-center">
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-[#C8A45D] tracking-[0.35em] uppercase text-xs font-inter mb-5">Book a Session</motion.p>
        <motion.h1 initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="font-playfair text-5xl md:text-6xl font-bold text-white tracking-tight">PROPERTY CONSULTATIONS</motion.h1>
      </section>
